...
<x-app-layout>
    ...
    <x-slot name="header">
        <h5 class="text-muted small ">Project Details</h2>
        ...
        <div class="mb-4">
            ...
            <div class="collapse" id="projectDescriptionCollapse">
                <div class="card card-body mt-2">
                    <p class="card-text cs-font"><strong>Project Type:</strong> {{ $project->service_type }}</p>
                    <p class="card-text cs-font"><strong>Industry:</strong> {{ $project->industry }}</p>
                    <p class="card-text cs-font"><strong>Description:</strong> {{ $project->description }}</p>
                    <p class="card-text cs-font"><strong>Target Audience:</strong> {{ $project->target_audience }}</p>
                    <p class="card-text cs-font"><strong>Design Preference:</strong> {{ $project->design_preference }}</p>
                    <p class="card-text cs-font"><strong>Color Preference:</strong>
                    ...
                    <p class="card-text cs-font"><strong>Notes:</strong> {{ $project->notes }}</p>
                    <p class="card-text cs-font">
        ...
        <div class="chat-container bg-white pt-3 border rounded-0">
            <ul class="chat-messages list-unstyled overflow-y-auto">
                ...
                <li class="text-center my-5">
                    <span class=" text-black-50 fs-2">No messages yet. Start the conversation!</span>
                </li>
                @endforelse
            </ul>
